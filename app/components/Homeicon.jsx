...
const Homeicon = () => {
  ...
  return (
    <div >
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={` ${currentroute==='/patients' || '/professionals'?'fill-[#3263CF] stroke-[#3263CF]':'fill-[#97A3B0] stroke-[#97A3B0]'} hover:fill-[#3263CF]  transition-all hover:stroke-[#3263CF]`}>
